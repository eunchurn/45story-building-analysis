...
% Last Modified by GUIDE v2.5 10-Jan-2011 13:49:19
...
% --- Executes on button press in allapply.
function allapply_Callback(hObject, eventdata, handles)
% hObject    handle to allapply (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
